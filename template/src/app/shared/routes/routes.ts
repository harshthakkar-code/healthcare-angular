export class routes {
  ...
  public static get twoFactorAuthentication(): string {
    return this.baseUrl + '/patients/two-factor-authentication';
  }
  ...
  public static get mapListAvailability(): string {
    return this.baseUrl + '/patients/doctors/map-list-availability';
  }
